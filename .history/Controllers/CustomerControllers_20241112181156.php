    ...
    class CustomerControllers {
        ...
        public function vnpay_payment($invID) {
            ...
            if ($invoiceInfo) {
                ...
                $influencerFullname = $invoiceInfo['Influ_Fullname'];
                $bookingContent = $invoiceInfo['Booking_Content'];
                ...
                $vnp_TxnRef = rand(1000, 9999); // Tạo mã đơn hàng ngẫu nhiên
                $vnp_OrderInfo = '$influencerFullname . " - " . $bookingContent;
                $vnp_OrderType = 'billpayment';
                $vnp_Amount = $invoiceInfo['Inv_VATamount']; // Giá trị đơn hàng (VNĐ)
                $vnp_Locale = 'vn';
                $vnp_BankCode = 'NCB';
