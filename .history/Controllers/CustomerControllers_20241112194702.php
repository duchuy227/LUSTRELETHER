<?php 
    ...
    class CustomerControllers {
        ...
        public function customer_paymentinfo($in){
            if(isset($_SESSION['is_login']) && $_SESSION['is_login'] === true && isset($_SESSION['cus_id'])) {
                $customerModel = new CustomerModels();
                $customer = $customerModel -> GetCustomerbyID($_SESSION['cus_id']);

                $paymentinfo = $customerModel -> GetInfoInvoiceByCusID($_SESSION['cus_id']);
        ...
        public function customer_paymentsuccess(){
            if(isset($_SESSION['is_login']) && $_SESSION['is_login'] === true && isset($_SESSION['cus_id'])) {
                ...
                if (isset($_GET['vnp_Amount'], $_GET['vnp_BankCode'], $_GET['vnp_BankTranNo'], $_GET['vnp_CardType'], $_GET['vnp_OrderInfo'], $_GET['vnp_TransactionNo'], $_GET['vnp_TransactionStatus'], $_GET['vnp_TxnRef'], $_GET['vnp_SecureHash'], $_GET['vnp_PayDate'], $_GET['vnp_ResponseCode'], $_GET['vnp_TMNCode'])) {
                    ...
                    $customerModel ->saveVNPayPayment($vnp_Amount, $vnp_BankCode, $vnp_BankTranNo, $vnp_CardType, $vnp_OrderInfo, $vnp_PayDate, $vnp_ResponseCode, $vnp_TMNCode, $vnp_TransactionNo, $vnp_TransactionStatus, $vnp_TxnRef, $vnp_SecureHash);
                }
