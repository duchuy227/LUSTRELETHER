<?php 
    ...
    class CustomerModels {
        ...
        public function saveVNPayPayment($vnp_Amount, $vnp_BankCode, $vnp_BankTranNo, $vnp_CardType, $vnp_OrderInfo, $vnp_PayDate, $vnp_ResponseCode, $vnp_TMNCode, $vnp_TransactionNo, $vnp_TransactionStatus, $vnp_TxnRef, $vnp_SecureHash){
            $query = "INSERT INTO VNPay_Transaction (VNP_Ammount, VNP_BankCode, VNP_BankTranNo, VNP_CardType, VNP_OrderInfo, VNP_PayDate, VNP_Respond_code, VNP_TMNCode, VNP_TransactionNo, VNP_TransactionStatus, VNP_TxnRef, VNP_SecureHash, Inv_ID) VALUES(:vnp_amount, :vnp_bank_code, :vnp_bank)";
        }
    }
?>