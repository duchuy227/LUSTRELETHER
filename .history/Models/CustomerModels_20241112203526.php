<?php 
    ...
    class CustomerModels {
        ...
        public function saveVNPayPayment($data){
            ...
            $query = "INSERT INTO VNPay_Transaction (VNP_Ammount, VNP_BankCode, VNP_BankTranNo, VNP_CardType, VNP_OrderInfo, VNP_PayDate, VNP_Respond_code, VNP_TMNCode, VNP_TransactionNo, VNP_TransactionStatus, VNP_TxnRef, VNP_SecureHash, Inv_ID) 
            ...
            $stmt->bindParam(':vnp_amount', $vnp_Amount);
            $stmt->bindParam(':vnp_bank_code', $vnp_BankCode);
            $stmt->bindParam(':vnp_bank_tranno', $vnp_BankTranNo);
            $stmt->bindParam(':vnp_card_type', $vnp_CardType);
            $stmt->bindParam(':vnp_order_info', $vnp_OrderInfo);
            $stmt->bindParam(':vnp_pay_date', $vnp_PayDate);
            $stmt->bindParam(':vnp_response_code', $vnp_ResponseCode);
            $stmt->bindParam(':vnp_tmn_code', $vnp_TMNCode);
            $stmt->bindParam(':vnp_transaction_no', $vnp_TransactionNo);
            $stmt->bindParam(':vnp_transaction_status', $vnp_TransactionStatus);
            $stmt->bindParam(':vnp_txn_ref', $vnp_TxnRef);
            $stmt->bindParam(':vnp_secure_hash', $vnp_SecureHash);
