<?php 
    ...
    class CustomerModels {
        ...
        public function saveMomoPayment($partnerCode, $orderId, $requestId, $amount, $orderInfo, $orderType, $transId, $payType, $signature, $inv_id){
            $query = "INSERT INTO Momo_Transaction (MT_PartnerCode, MT_OrderID, MT_RequestID, MT_Ammount, MT_OrderInfo, MT_OrderType, MT_TransID, MT_PayType, MT_Signature, Inv_ID) VALUES (:partnerCode, :orderId, :requestId, :amount, :orderInfo, :orderType, )";
