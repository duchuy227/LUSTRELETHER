<?php 
    ...
    class InfluencerModels {
        ...
        public function AddNoteToBooking($booking_id, $note){
            $query = "UPDATE Booking SET Booking_Note = :note WHERE Booking_ID = :booking_id";
            $sql = $this->conn->prepare($query);
            $sql->execute([':note' => $note, ':booking_id' => $booking_id})
