    ...
    class InfluencerModels {
        ...
        public function TimeLine($influ_id) {
            ...
            foreach ($bookings as $booking) {
                ...
                // Nếu start date và end date là cùng một ngày, chỉ hiển thị một ngày
                if ($start == $end) {
                    $timeline[] = [
                        'Date' => $start->format('d/m/Y'), // Thêm năm vào
                        'Booking_Content' => $booking['Booking_Content'],
                        'Booking_Status' => $booking['Booking_Status']
                    ];
                } else {
                    // Nếu start date và end date khác nhau, hiển thị ngày bắt đầu và ngày kết thúc
                    $timeline[] = [
                        'Date' => $start->format('d/m/Y') . ' - ' . $end->format('d/m/Y'), // Thêm năm vào
                        'Booking_Content' => $booking['Booking_Content'],
                        'Booking_Status' => $booking['Booking_Status']
                    ];
                }
