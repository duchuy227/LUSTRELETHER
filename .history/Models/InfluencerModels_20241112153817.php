<?php 
    ...
    class InfluencerModels {
        ...
        public function CreateInvoiceForBooking($booking_id, $booking_expense) {
            $query = "INSERT INTO Invoice (Inv_TotalAmount, Inv_VATamount, Inv_Status, Booking_ID, MT_ID, VN) 
                      VALUES (:total_amount, :vat_amount, 'Unpaid', NULL, :booking_id)";
                      
            $stmt = $this->conn->prepare($query);
            $vat_amount = $booking_expense * 0.15; // Tính 15% VAT
            $stmt->execute([
