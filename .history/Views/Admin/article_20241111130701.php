        ...
        <main>
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex align-items-center">
                    <h2 style="font-size: 40px; font-weight:bold; color:#333333">Article</h2>
                </div>
                ...
                <div class="profile">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="hello">
                            ...
                            <tr>
                                <td style="font-size: 16px; font-weight: 300; color: #333333" scope="row"><?php echo $a['Post_CreateTime'] ?></td>
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row"><?php echo $a['Post_Title'] ?></td>
                                
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row"><?php echo $a['Influ_Username'] ?></td>
                                ...
                                <td style="font-size: 16px; font-weight: 300; text-align: left;  width: 80px" scope="row">
                                    <div style="margin: auto; width: 80px;" class="d-inline-flex justify-content-between align-items-center">
                                        <?php if ($a['Post_Status'] === 'Pending'): ?>
                                            <a href="index.php?action=admin_detailarticle&id=<?php echo $a['Post_ID']; ?>">
                                                <img src="././Views/Img/u223.png" width="30" height="30">
                                            </a>
                                            <a href="index.php?action=admin_commentarticle&id=<?php echo $a['Post_ID']; ?>">
                                                <img src="././Views/Img/comments.png" width="30" height="30">
                                            </a>
