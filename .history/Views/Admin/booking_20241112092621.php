                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="hello">
                            <?php foreach ($booking as $b): ?>
                                <?php echo $b['Booking_ID']; // Kiểm tra xem có giá trị Booking_ID không ?>
                            <tr>
                                ...
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row">
                                    <a href="index.php?action=admin_detailbooking&id=<?php echo $b['Booking_ID']?>">
