        ...
        <main>
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex align-items-center">
                    <h2 style="font-size: 40px; font-weight:bold; color:#333333">Edit Content</h2>
                </div>
            ...
            <div class="recent_order">
                <div class="profile">
                    <form action="index.php?action=admin_editContent&id=<?php echo $contents['Content_ID']; ?>" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="content_name">Name</label>
                                <input type="text" class="form-control" id="content_name" name="content_name" value="<?php echo $contents['Content_Name']; ?>">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="content_des">Description</label>
                                <textarea type="text" class="form-control" id="content_des" name="content_des" ><?php echo $contents['Content_Description']; ?></textarea>
                            </div>
                        </div>
