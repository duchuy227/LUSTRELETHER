        ...
        <main>
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex align-items-center">
                    <h2 style="font-size: 40px; font-weight:bold; color:#333333">Edit Violation</h2>
                </div>
            ...
            <div class="recent_order">
                <div class="profile">
                    <form action="index.php?action=admin_editviolation&id=<?php echo $violation['Vio_ID']; ?>" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="violation_name">Name of Violation</label>
                                <input type="text" class="form-control" id="violation_name" name="violation_name" value="<?php echo $violation['Vio_Name']; ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="keywords">Word</label>
                                <textarea type="text" class="form-control" id="keywords" name="keywords" required><?php echo implode(', ', $violation_words); ?></textarea>
                            </div>
                        </div>
