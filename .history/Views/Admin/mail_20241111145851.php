        ...
        <main>
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex align-items-center">
                    <h2 style="font-size: 40px; font-weight:bold; color:#333333"><i class="fas fa-mail-bulk    "></i></h2>
                </div>
            ...
            <div class="recent_order">
                <div class="profile">
                    <br>
                    <h3 style="text-align: center; margin-top: 20px;">List of accounts pending approval</h3>
                    <br>
                            ...
                            <tr>
                                ...
                                <td style="font-size: 16px; font-weight: 400; text-align: left" scope="row">
                                    <div class="row d-flex justify-content-center">
                                        <a href="index.php?action=admin_changestatus&id=<?php echo $influ['Influ_ID']; ?>">
                                            <img src="././Views/Img/change.png" width="30" height="30">
                                        </a>
                                    </div>
                                </td>
                            </tr>
