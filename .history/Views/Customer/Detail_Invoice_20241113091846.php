...
<body>
    ...
    <div class="container-fluid">
        ...
        if (!empty($invoiceDetails['method'])) {
            echo $invoiceDetails['method'];  // Hiển thị phương thức thanh toán (Momo hoặc VNPay)
        } else {
            echo 'No payment method';  // Nếu không có phương thức thanh toán
        }
    ?>
                                    </label>
                                </div>
                    ...
                    <h4><?php echo $invoiceDetails['method']; ?> Transaction Detail</h4>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row mt-3">
                                <div class="col-md-6" style="width: 35%">
