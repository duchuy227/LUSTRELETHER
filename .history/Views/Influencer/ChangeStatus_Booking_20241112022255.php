                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $booking['Topic_Name']; ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control" name="status">
                                                    <option value="In Progress" <?php echo ($booking['Booking_Status'] === 'In Progress') ? 'selected' : ''; ?>>Approval</option>
                                                    <option value="Pending" <?php echo ($booking['Booking_Status'] === 'Pending') ? 'selected' : ''; ?>>Pending</option>
                                                    <option value="Rejected" <?php echo ($booking['Booking_Status'] === 'Rejected') ? 'selected' : ''; ?>>Rejected</option>
                                                </select>
                                            </div>
                                        </div>
