                        ...
                        <div class="row">
                            <div class="projectCardd">
                                <div class="projectTopp">
                                    <h4 style="color: #847F7F; font-size: 26px; font-weight:bold" class="text-center">Edit Article</h4>
                                    <br>
                                    <form id="addArticleForm" onsubmit="return handleFormSubmit(event);" enctype="multipart/form-data" method="post">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="">Title</label>
                                            <input type="text" class="form-control" id="title" name="title" value="<?php echo  $article['Post_Title'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="">Hastag</label>
                                            <input type="text" class="form-control" id="title" name="hastag" value="<?php echo  $article['Post_Hastag'] ?>">
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input name="status" type="text" readonly class="form-control" value="<?php echo  $article['Post_Status'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <label for="">Content</label>
                                            <textarea name="content" class="form-control" rows="5"><?php echo  $article['Post_Content'] ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
