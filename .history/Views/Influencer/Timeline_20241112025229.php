                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td style="font-weight: 500; color: <?php 
                                        ...
                                        <td>
                                        <?php
// Giả sử bạn có thông tin về Booking, Start_Date và End_Date trong mảng $t
$startDate = $t['Booking_StartDate']; // Ngày bắt đầu (YYYY-MM-DD)
$endDate = $t['Booking_EndDate'];     // Ngày kết thúc (YYYY-MM-DD)
$currentDate = date("Y-m-d");         // Ngày hiện tại

// Kiểm tra nếu Booking_Status là 'In Progress' và ngày hiện tại nằm trong khoảng Start_Date và End_Date
if ($t['Booking_Status'] === 'In Progress' && $currentDate >= $startDate && $currentDate <= $endDate):
?>
    <a href="#">
