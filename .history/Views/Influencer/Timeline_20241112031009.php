                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <td style="font-weight: 500; color: <?php 
                                        ...
                                        <td>
                                        <?php
                                        // Lấy ngày và trạng thái từ timeline
                                        $currentDate = date("Y-m-d");  // Ngày hiện tại

                                        // Kiểm tra nếu trạng thái là 'In Progress' và ngày hiện tại không vượt quá ngày đã lưu
                                        if ($t['Booking_Status'] === 'In Progress' && $currentDate <= $t['Date']):
                                        ?>
                                            <a href="#">
        ...
        function renderCalendar() {
            ...
            for (let i = 1; i <= lastDayDate; i++) {
                ...
                if (isTodayOrFuture) {
                    ...
                    if (isCompleted) {
                        dayClass = "past";  // Nếu booking đã hoàn thành, thêm lớp completed
                    }
                    dayClass += " completed";  // Thêm lớp past cho các ngày đã qua
                }
