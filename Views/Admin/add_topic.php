                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <textarea type="text" class="form-control" id="topic_des" name="topic_des" ></textarea>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="topic_image">Image</label>
                                <input style="border:none" type="file" class="form-control" id="topic_image" name="topic_image">
                            </div>
                        </div>
