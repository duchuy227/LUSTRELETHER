        ...
        <main>
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex align-items-center">
                    <h2 style="font-size: 40px; font-weight:bold; color:#333333"> Change Status</h2>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="profile-container p-5">
                                <img class="img-small"  src="<?php echo $influencers['Influ_ImageAuth']; ?>" width="356" height="400" class="img-fluid"/>
                                <img class="img-fullscreen"  src="<?php echo $influencers['Influ_ImageAuth']; ?>" width="356" height="383" class="img-fluid"/>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="info p-5">
                    ...
                    <form action="" method="post">
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" name="new_status">
                                <option value="Active" <?php echo ($influencers['Influ_Status'] === 'Active') ? 'selected' : ''; ?>>Active</option>
                                <option value="Pending" <?php echo ($influencers['Influ_Status'] === 'Pending') ? 'selected' : ''; ?>>Pending</option>
                                <option value="Rejected" <?php echo ($influencers['Influ_Status'] === 'Rejected') ? 'selected' : ''; ?>>Rejected</option>
                            </select>
                        </div>
