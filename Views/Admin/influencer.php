        ...
        <main>
            <div class="row align-items-center">
                ...
                <div class="col-md-9 d-flex align-items-center">
                    <h2 style="font-size: 40px; font-weight:bold; color:#333333">Influencer</h2>
                </div>
            ...
            <div class="row" style="margin-top: 20px;">
                <div class="col-md-4">
                    <div class="row">
                        <a href="index.php?action=admin_Addinfluencer"><button style="width: auto; color: white; font-weight: 500; margin-left: 20px" type="submit" class="btn btn-primary">Add Influencer</button></a>
                    </div>
                </div>
                ...
                <div class="profile">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr class="table-active">
                                ...
                                <th style="font-size: 18px; font-weight: 400;">Type</th>
                                <th style="font-size: 18px; font-weight: 400;">Status</th>
                                <th style="width: 15%" scope="col">&nbsp;</th>
                            </tr>
                        </thead>
                        <tbody class="hello">
                            <?php foreach ($influencers as $influ): ?>
                            <tr>
                                <td style="font-size: 16px; font-weight: 300; color: #333333" scope="row">
                                    <?php echo  $influ['Influ_Username']; ?>
                                </td>
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row">
                                    <?php echo  $influ['Influ_Email']; ?>
                                </td>
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row">
                                    <?php echo  $influ['Influ_Fullname']; ?>
                                </td>
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row">
                                    <?php echo  $influ['InfluType_Name']; ?>
                                </td>
                                <td style="font-size: 16px; font-weight: 400; text-align: left; 
                                        color: <?php 
                                            if ($influ['Influ_Status'] === 'Pending') {
                                                echo '#FF6600';
                                            } elseif ($influ['Influ_Status'] === 'Rejected') {
                                                echo '#F07070'; 
                                            } elseif ($influ['Influ_Status'] === 'Active') {
                                                echo '#009900';
                                            }
                                        ?>;">
                                ...
                                <td style="font-size: 16px; font-weight: 300; text-align: left" scope="row">
                                    <div class="row d-flex justify-content-center" style="gap: 10px;">
                                        ...
                                        <?php elseif ($influ['Influ_Status'] === 'Rejected'): ?>
                                            <a href="index.php?action=admin_deleteinfluencer&id=<?php echo $influ['Influ_ID']; ?>" onclick="openPopup(event);">
                                                <img src="././Views/Img/deletecus_u544.png" width="30" height="30">
                                            </a>
                                            <a href="index.php?action=admin_detailinfluencer&id=<?php echo $influ['Influ_ID']; ?>">
                                                <img src="././Views/Img/u223.png" width="30" height="30">
                                            </a>
                                        <?php elseif ($influ['Influ_Status'] === 'Active'): ?>
                                            <a href="index.php?action=admin_editinfluencer&id=<?php echo $influ['Influ_ID']; ?>">
                    ...
                    <div id="deletePopup" class="popup">
                        <div class="popup-content">
                            <p>Are you sure to delete <br>this Influencer ?</p>
