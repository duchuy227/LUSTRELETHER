                    ...
                    <table style="max-width:100%" class="table table-bordered">
                        <thead>
                            <tr class="table-primary">
                                <th style="font-size: 16px; font-weight: 400;">Time</th>
                                <th style="font-size: 16px; font-weight: 400;">Influencer</th>
                                <th style="font-size: 16px; font-weight: 400;">Booking</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $f['Influ_Nickname'] ?></td>
                                    <td><?php echo $f['Booking_Content'] ?></td>
                                    <td>
                                        <textarea readonly style="background: transparent;outline:none; resize: none; border:none; width: 100%" rows="3"><?php echo $f['Feed_Content']?></textarea>
                                    </td>
                                </tr>
                                <?php  endforeach; ?>
                        </tbody>
