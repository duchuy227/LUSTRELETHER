                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group position-relative">
                                    ...
                                    <input class="form-control" readonly value="<?php echo $booking['Influ_Nickname'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group position-relative">
                                    ...
                                    <input class="form-control" value="<?php echo $booking['Booking_Content'] ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group position-relative">
                                    ...
                                    <input style="color: #069603;" class="form-control" value="<?php echo $booking['Booking_Status'] ?>" readonly>
                                </div>
                            </div>
